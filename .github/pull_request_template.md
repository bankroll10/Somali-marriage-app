<!--
  The release-review checklist from docs/PROCESS.md, in front of every PR so
...
- [ ] A new closed list or readout field is documented (`docs/OPERATING.md`'s
      field table, `docs/LEARNING.md`'s collected list) — if it applies
- [ ] If this carries a hypothesis bigger than a copy fix, it has an entry in
      `docs/EXPERIMENTS.md` with a decision rule already written
