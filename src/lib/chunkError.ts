 ...
 *
 * Every screen past Welcome is a lazy chunk (docs/PERFORMANCE.md), and the
 * app shell now loads offline (src/lib/serviceWorker.ts, docs/LINKS.md). Put
 ...
 * STRIDE pass (docs/THREAT.md, T18).
 *
