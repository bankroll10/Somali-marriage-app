...
const TEXT: Record<InviteSource, string> = {
 ...
 'Talking to someone? Niyyah reads what {he}’s done — not what {he} says — in ninety seconds, and gives you the one question to ask {him} next. Built for us. No swiping, no account.',
  ...
  couple:
    'Before you say yes — the eleven conversations to have before the families do: where you’d live, money home, a second wife. We did them on Niyyah, each on our own phone; neither of us saw the other’s answers, only where we matched. Two minutes. No account.',
}
