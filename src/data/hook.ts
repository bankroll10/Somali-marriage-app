...
Niyyah is built around exactly this: reading intention early, so you stop guessing. Your guide will look at real situations with you — and the map you’re about to build is what makes that guidance yours.`,
  },
  {
    id: 'family',
...
Your map will show where you stand, in words, and your guide will take the rest in your own.`,
  },
  {
    ...
    insight: (name) =>
 `${name ? `${name}, a` : 'A'}sking that question honestly already puts you ahead of most people who are out there swiping. Readiness isn’t a feeling you wait for — it’s a handful of things you can look at: your intention, your heart’s patterns, what you need, what you won’t compromise.
