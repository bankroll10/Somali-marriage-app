...
| `DOOR_CITY_HOURLY_CAP` | Joins into any **one** city's door in one hour — so a script cannot fill a city to a false 40/40 inside the site-wide cap (`docs/ABUSE.md`, spam). One variable for every city. | `30` |
