...
| 6 | **The eleven are not what breaks marriages** | F; central (L5) | `ended.reason`, `.which`; `/couple` `both-not-talked` per topic. What breaks a marriage is never measured here (no marital follow-up, `docs/DECISIONS.md` Part 14): this reads what ends courtships, and a marriage cannot answer it |
