...
| **4** | **The situations become the front door.** The four moments and five hardest parts move ahead of the map; **no new component** — `data/moments.ts` and `data/hook.ts` already exist and render 43 taps in | Solution, relocation | O1, O3.1, O4.2, O8.1 | Item 1 |
