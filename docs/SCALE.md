...
| A scheduled sweep: expired progress records, cohort entries whose `index/<code>` has no map, orphan vouches | the first orphan found in the yearly listing (`docs/OPERATING.md`) |
