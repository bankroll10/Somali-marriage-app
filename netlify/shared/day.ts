 ...
 * harmless; together they were a join. `he-answered` on the ladder was
 * written within one poll of the pair's `answeredAt` — so anyone holding two
 * stores could line their records up by the clock, and the promise that the
