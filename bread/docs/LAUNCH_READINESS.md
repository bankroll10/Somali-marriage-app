...
| 8 | Cutoff −1 ms / 0 / +1 ms; both 2026 DST changes; sessions near the cutoff end at the cutoff | PASSED | `launch.test.ts` S8 (Mar 9 and Nov 2 pickups: cutoff 5 PM the day before — the rule since 2026-09-23, was 48 h; fake enforces Stripe's 30-minute rule); `schedule.test.ts` checks every pickup day for a year |
