...
| **Pickup location and instructions** | ✅ **Changed by Biz 2026-09-24: "Local pickup — text for pickup location."** Life Time can't be used, so no venue is named anywhere (a test enforces it). Hours unchanged: 5–11 PM, best after 9 PM — those were her shift; confirm they still hold | Done — `PICKUP_LOCATION` |
...
| Prices and capacity | Sourdough $5 (3 per day); **banana bread in two sizes (Biz, 2026-09-24): small $3 (4 per day), large $7 (1 per day)**, tracked apart in "To bake" | The `products` table (a `UPDATE` by the owner; the site reads it) — a capacity change applies to dates nobody has ordered on yet |
...
| **Approved product descriptions** | "A full loaf" / "Small loaf" / "Large loaf". The large loaf shows the same ingredients as the small one (same bread, bigger) | Same |
| **Cancellation and refund terms** | ✅ **Confirmed 2026-09-23:** no refunds for a missed pickup; she brought it to Life Time on her next shift. **Since pickup moved (2026-09-24):** "text me and we'll set up another pickup" — our rewording of the same policy, sent to her to confirm. Shown in the review before paying and on the confirmation. Worded about a *missed pickup* only, so it never promises no refund when she is the one who cancels | `MISSED_PICKUP` |
