...
import { stripeAccountChecks, type AccountLike, type WebhookEndpointLike } from '../scripts/checks.ts'
...
const endpoint = (over: Partial<WebhookEndpointLike> = {}): WebhookEndpointLike => ({ url: HOOK, status: 'enabled', enabled_events: [...REQUIRED_WEBHOOK_EVENTS], ...over })
